public class StringEx6 {
	public static void main(String[] args) {
		...
		System.out.println(s1.indexOf("Patankar"));
		System.out.println("  ram          kumar  ".trim());
		System.out.println(s1.equals(s2));
		System.out.println(s1.equals("Vikky Patankar"));
		System.out.println(s1.equals("Vikky Patankar"));
		System.out.println(s1.equalsIgnoreCase("Vikky Patankar"));
